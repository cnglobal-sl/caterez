...
abstract class Mage_Sales_Model_Order_Pdf_Abstract extends Varien_Object
{
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        if($additionalData = Mage::getModel('fieldsmanager/fieldsmanager')->GetFMData($order->getEntityId(),'orders',$pdftype)){
         ...
         $page->setFillColor(new Zend_Pdf_Color_Rgb(0.93, 0.92, 0.92));
           ...
           // $page->drawRectangle(275, $this->y, 570, $this->y-25);
            ...
            $page->setFillColor(new Zend_Pdf_Color_GrayScale(0));
            $page->drawText(Mage::helper('fieldsmanager')->getheading(), 35, $this->y, 'UTF-8');
            //$page->drawText(Mage::helper('sales')->__('Shipping Method:'), 285, $this->y , 'UTF-8');
            ...
            foreach ($additionalData as $value){
               // echo $value . "----";
                if(strlen(trim($value)) != 0){
                    ...
                    $page->drawText($value, $paymentLeft, $yPayments, 'UTF-8');
            ...
            $page->setLineWidth(0.5);
            $page->setLineColor(new Zend_Pdf_Color_GrayScale(0.5));
            $page->drawLine(25, $this->y, 25, $yPayments);
            $page->drawLine(25, $yPayments, 570, $yPayments);
            $page->drawLine(570, $this->y, 570, $yPayments);
            //$page->drawLine(25, $this->y, 25, $yPayments);
