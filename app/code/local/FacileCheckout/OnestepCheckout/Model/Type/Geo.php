...
include("CogMaxMind/GeoIP/geoip.inc");

include("CogMaxMind/GeoIP/geoipcity.inc");

include("CogMaxMind/GeoIP/geoipregionvars.php");
...

{
...

    {
        ...
        {        	
...

			{
				...
				$query_sales_flat_order="UPDATE `sales_flat_order` SET `grand_total`= '$base_grand_price_totals', `base_grand_total` = '$base_grand_price_totals',`giftwrap` = '1' ,`giftwrap_price` = '$giftwrap_admin_price' WHERE `quote_id` ='$osc_quote_id'"; // sales_flat_order table
...

    {
        ...
        $a_form = Mage::getStoreConfig('onestepcheckout/address_form');
