...
class FME_Fieldsmanager_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    function getheading(){
	if($this->getStoredDatafor('heading') != ''){
    ...
    { if(Mage::helper('fieldsmanager')->getStoredDatafor('enable')){
	    $collection=Mage::getModel('fieldsmanager/fieldsmanager')->getAllFieldsHtml('6', $locate , 'fm_fields', 'catalog' , '<div class="d_2 review_fields">' , '</div>');
    ...
    {
	  if(Mage::helper('fieldsmanager')->getStoredDatafor('enable')){
	       $collection=Mage::getModel('fieldsmanager/fieldsmanager')->getAllFieldsHtml('2', $locate , 'fm_fields', 'catalog' , '<div id="fme_billing_'.$locate.'" class="full">' , '</div>');
	       return $collection;
	  }
    }
}
