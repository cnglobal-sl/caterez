...
class FME_Fieldsmanager_Block_Adminhtml_Fieldsmanager_Edit_Tab_Options extends Mage_Adminhtml_Block_Widget
{

    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('fieldsmanager/options.phtml');
    }
...
//        $values = array();
//        
//		$translations = Mage::getModel('fieldsmanager/fieldsmanager')->getAttributeDescription($this->getAttributeObject()->getId());
//        
//        foreach ($this->getStores() as $store) {
...
//    }
    ...
    public function getNeedSelectValues()
    {
		...
		$translations = Mage::getModel('fieldsmanager/fieldsmanager')->getAttributeNeedSelect($this->getAttributeObject()->getId());
