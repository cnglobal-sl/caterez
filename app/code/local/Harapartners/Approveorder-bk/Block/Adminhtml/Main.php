<?php
class Harapartners_Approveorder_Block_Adminhtml_Main extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        $this->setTemplate('harapartners/approveorder/kitchen.phtml');
    }
    ...
    public function getStatistic()
    {
		...
		if(count($itemArray)){
			...
			foreach($itemArray as $item){
				$html .= '<tr><th>' . $item['name'] . '</th><td style="color:red; font-weight:bold;">' . $item['qty'] . '</td></tr>';
			}
			$html .= '</table>';
		}
		return $html;
