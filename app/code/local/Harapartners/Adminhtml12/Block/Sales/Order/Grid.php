 ...
 */
class Harapartners_Adminhtml_Block_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('created_at', array(
            'header' => Mage::helper('sales')->__('Order Place Date'),
            'index' => 'created_at',
            'type' => 'datetime',
        ...
        $this->addColumn('cleaning_time', array(
            'header' => Mage::helper('sales')->__('Cleaning Time'),
            'index' => 'cleaning_time',
            'type' => 'datetime',
			'format' => 'EE dd/MM/yyyy H:m:s',
        ));
...
/*        $this->addColumn('shipping_name', array(
        ...
        $this->addColumn('cost_center', array(
            'header' => Mage::helper('sales')->__('Cost Centre'),
            'index' => 'cost_center',
        ));
        
        $this->addColumn('delivery_venue', array(
            'header' => Mage::helper('sales')->__('Delivery Venue'),
            'index' => 'delivery_venue',
        ));
        
        $this->addColumn('function', array(
            'header' => Mage::helper('sales')->__('Title of Function'),
            'index' => 'function',
        ));
...
/*        $this->addColumn('approved_by', array(
            'header' => Mage::helper('sales')->__('Approved by'),
            'index' => 'approved_by',
            'type' => 'text',
            'width' => '100px',
        ));
        ...
        $this->addColumn('manager_comment', array(
            'header' => Mage::helper('sales')->__('Manager Comment'),
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('export_order', array(
             'label'=> Mage::helper('sales')->__('Export Selected Orders'),
             'url'  => $this->getUrl('approveorder/admin/massOrderExport'),
        ));
