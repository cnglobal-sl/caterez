 ...
 */
class Ophirah_Qquoteadv_Model_Tax extends Mage_Sales_Model_Quote_Address_Total_Abstract
{
    /**
     * Tax module helper
     *
     ...
     */
    public function collect(Ophirah_Qquoteadv_Model_Address $address)
    {
     ...
     * @return  Mage_Tax_Model_Sales_Total_Quote
     */
    protected function _calculateShippingTax(Ophirah_Qquoteadv_Model_Address $address, $taxRateRequest)
    {
     ...
     * @return  Mage_Tax_Model_Sales_Total_Quote
     */
    protected function _unitBaseCalculation(Ophirah_Qquoteadv_Model_Address $address, $taxRateRequest)
    {
        $items = $this->_getAddressItems($address);
        $itemTaxGroups  = array();
     ...
     * @return  Mage_Tax_Model_Sales_Total_Quote
     */
    protected function _calcUnitTaxAmount(Ophirah_Qquoteadv_Model_Requestitem $item, $rate)
    {
     ...
     * @return  Mage_Tax_Model_Sales_Total_Quote
     */
    protected function _rowBaseCalculation(Ophirah_Qquoteadv_Model_Address $address, $taxRateRequest)
    {
        $items = $this->_getAddressItems($address);
        $itemTaxGroups  = array();
        foreach ($items as $item) {
     ...
     * @return  Mage_Tax_Model_Sales_Total_Quote
     */
    protected function _totalBaseCalculation(Ophirah_Qquoteadv_Model_Address $address, $taxRateRequest)
    {
        $items          = $this->_getAddressItems($address);
